...
# Add package needed
sed -i -e '59s/ddns-scripts_aliyun ddns-scripts_dnspod luci-app-ddns luci-app-upnp luci-app-autoreboot/vpn-policy-routing luci-app-vpn-policy-routing luci-app-wireguard luci-proto-wireguard wireguard-tools kmod-wireguard luci-app-qbittorrent luci-app-cifs-mount luci-app-samba4 nano htop curl/'  include/target.mk
