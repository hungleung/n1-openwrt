...
sed -i '90s/"Shadowsocks-libev"/"None"/'  feeds/helloworld/luci-app-ssr-plus/Makefile
...
sed -i -e '61s/luci-app-nlbwmon/luci-app-nfs luci-app-serverchan bird1c-ipv4 bird1cl-ipv4 git git-gitweb git-http luci-app-bird1-ipv4 make python3/' include/target.mk