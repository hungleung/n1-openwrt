...
# Add package needed
sed -i -e '59s/ddns-scripts_aliyun ddns-scripts_dnspod luci-app-ddns luci-app-upnp luci-app-autoreboot/ luci-app-ddns luci-app-upnp luci-app-udpxy ddns-scripts_cloudflare.com-v4 luci-app-qbittorrent luci-app-amlogic luci-app-openclash luci-ssl-openssl luci-app-samba4 nano htop/'  include/target.mk
# Add nfs
